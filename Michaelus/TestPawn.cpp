	...
	Pawn(name)
{
	...
	pCameraComponent->AddRelativeLocation(FVec3D(50.f, 0.f, 50.f));
	...
	pCameraComponent2->AddRelativeLocation(FVec3D(0.f, 50.f, 25.f));
	...
	pCameraComponent3->AddRelativeLocation(FVec3D(25.f, -25.f, -25.f));
	...
	pCameraComponent4->AddRelativeLocation(FVec3D(10.f, 0.f, -50.f));
	...
	pCameraComponent5->AddRelativeLocation(FVec3D(50.f, 0.f, 0.f));
}
